<x-app-layout>
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold">Areas</h1>
    ...
    <!-- Search -->
    <div class="mb-4">
        <input id="searchInput" type="text" placeholder="Search areas..."
                    ...
                    <tr class="border-b dark:border-slate-700 hover:bg-gray-50 dark:hover:bg-slate-700 transition">
                        ...
                        <td class="px-4 py-3 flex gap-2">
                            ...
                            <form action="{{ route('areas.destroy', $area->id) }}" method="POST">
                                ...
                                @method('DELETE')
                                <button type="button"
                                    @click="$dispatch('confirm-delete', { url: '{{ route('areas.destroy', $area->id) }}' })"
